        ...
        protected override void RenderElementActions()
        {
            ...
            SendResponse(
                ...
                new InteractionEventArgs<string>( // The response format, the type associated depends on the type of the interactive element. We defined InteractDemo : InteractiveElement<string>, so the type is string.
                    key.Key == ConsoleKey.Enter ? Output.Select : Output.Exit, // The first parameter is always an Output enum. Here we use the Output enum to determine whether the user pressed Enter or Escape.
            ...
            // The Interactive element may be used just for an element that need to be interactive but without any response (like the EmbeddedText).
        }
        #endregion
    }
}
